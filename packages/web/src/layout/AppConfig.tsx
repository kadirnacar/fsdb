  ...
  return (
    <>
      ...
      >
        {!props.simple && (
          <>
            <h5>Boyut ({layoutConfig.scale})</h5>
            <div className="col-12 flex align-items-center">
              ...
              <Slider
                ...
                className="m-3"
                onChange={(e) => {
                  setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, scale: e.value as number }));
                }}
              />
              <Button
                icon="pi pi-plus"
            ...
            <div className="flex">
              <div className="field-radiobutton flex-1">
                <RadioButton
                  ...
                  inputId="mode1"
                ></RadioButton>
                <label htmlFor="mode1">Sabit</label>
              </div>
              <div className="field-radiobutton flex-1">
                <RadioButton
                  name="menuMode"
                  ...
                  inputId="mode2"
                ></RadioButton>
                <label htmlFor="mode2">Gizli</label>
              </div>
            </div>
